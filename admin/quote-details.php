...
<div class="page-container row"> 
  ...
  <div class="page-content"> 
	...
	<?php
							$id=$_GET['id'];
							$sql="SELECT * FROM prequest WHERE id='$id'";
      			...
      			<div class="row">
					<div class="col-md-12">
							...
							<div class="grid-title no-border">
								<h4><?php echo $row['name']?> table's Quote <span class="semi-bold">Details</span></h4>
								<div class="tools">
...
if(isset($_POST["remark"])) {	
	...
	$remark_query="UPDATE prequest SET remark='$remark' WHERE id='$id'";
	$remark_run=mysqli_query($conn,$remark_query);
	if($remark_run){
		echo "<script>alert('remark update ..!!')</script>";
	}else{
		echo "remark not updated";
	}
