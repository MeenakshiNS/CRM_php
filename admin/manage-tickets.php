...
<div class="page-container row"> 
        ...
        <div class="col-md-12">
          <div class="grid simple no-border">
            <div class="grid-title no-border descriptive clickable">
              <h4 class="semi-bold"><?php echo $arr['subject']  ?></h4>
              <p ><span class="text-success bold">Ticket #<?php echo $arr['ticket_id'] ?></span> - Created on (<?php echo $arr['posting_date']  ?>)
             <span class="label label-important"><?php echo $arr['status'] ?></span></p>
            ...
            <div class="grid-body  no-border" style="display:none">
              <div class="post">
                ...
                <div class="info-wrapper">
                  <div class="info"><?php echo $arr['ticket']  ?></div>
                  <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
              </div>
              ...
              <div class="form-actions">
                <div class="post col-md-12">
                  <div class="user-profile-pic-wrapper">
                    <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="./images.png" data-src="./images.png" src="./images.png" alt=""> </div>
                  </div>
                  <div class="info-wrapper">
 ...
 <form name="adminr"  method="post" enctype="multipart/form-data">
                      <br>
                     <textarea name="aremark" cols="50" rows="4" required="true"><?php echo $arr['admin_remark']?></textarea>
                      <hr>
                      <p class="small-text"> 
                        <input name="update" type="submit"  class="txtbox1" id="Update" value="update" size="40" />
 <input name="frm_id" type="hidden" id="frm_id" value="<?php echo $arr['id'];?>" /></p>
                      </form>

                      <?php
                      if(isset($_POST['update'])){
                        $remark=$_POST['aremark'];
                        $id=$_POST['frm_id'];
