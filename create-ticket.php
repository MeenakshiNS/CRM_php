...
if(isset($_POST['send'])){
    ...
    $ticket_id = md5(uniqid($email, true));
    
    $ticket="INSERT INTO ticket(ticket_id,email_id,subject,task_type,priority,ticket) VALUES('$ticket_id','$email','$subject','$tasktype','$priority','$description')";

    $ticket_run=mysqli_query($conn,$ticket);
    if($ticket_run){
        echo "ticket created";
    }else{
